...
*   *NEW* FiroMiner v1.0.0 (official no-fee miner from FIRO coin devs for upcoming hardfork at Oct 26, 2021; Notes: due bad performance for AMD GPUs we strongly suggest to use TeamRedMiner)
