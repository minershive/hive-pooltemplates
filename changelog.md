...
*   XMRig v6.16.5-mo1 (synced with XMRig v6.16.5-dev; added support `astrobwt/v2` for mining DERO-HE coin algo)
*   CPUminer-Opt-JayDDee v3.19.7 (fixed time limited mining `time-limit` option)
*   XMRigCC v3.2 (rebase upstream 6.16.5-dev; added support DERO-HE: `astrobwt/v2` algorithm)
