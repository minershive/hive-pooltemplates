...
*   SRBMiner-Multi v2.4.1 (Added algorithm `karlsenhash` for AMD/NVIDIA/INTEL GPU mining KLS/Karlsen Network, fee 1.0%; Added algorithm `randomnevo` for CPU mining NEVO/NevoCoin, fee 0.85%; Notes: see full changelog at https://github.com/doktor83/SRBMiner-Multi/releases/tag/2.4.1)
