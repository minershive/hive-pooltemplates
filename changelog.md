...
*   CPUminer-Opt-JayDDee v3.18.0 (omplete rewrite of Scrypt code: up to 50% increase in hashrate, support AVX512 & SHA support for SHA25; improved stale share handling for all algorithms; other improvements and bug fixes)
